...
var brand = $('.lattest-product-area').attr('id');
...
function prod(index){
    ...
    selectedPrice = products[index].productPrice[i].price;
...
function buildBrand() {
    for (var i = 0; i < products.length; i++) {
        if (products[i].productBrand == brand){
            buildSingle(i);
        }
    }
}
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">\
                    <ul class="nav navbar-nav menu_nav ml-auto">\
                        ...
                        <li class="nav-item active submenu dropdown">\
                            ...
                            <ul class="dropdown-menu">\
                                <li class="nav-item"><a class="nav-link" href="bvlgari-brand.html">Bvlgari</a></li>\
                                <li class="nav-item"><a class="nav-link" href="chanel-brand.html">Chanel</a></li>\
                                <li class="nav-item"><a class="nav-link" href="chloe-brand.html">Chloé</a></li>\
                                <li class="nav-item"><a class="nav-link" href="dior-brand.html">Dior</a></li>\
                                <li class="nav-item"><a class="nav-link" href="dolcegabbara-brand.html">DOLCE & GABBANA</a></li>\
                                <li class="nav-item"><a class="nav-link" href="gucci-brand.html">Gucci</a></li>\
                                <li class="nav-item"><a class="nav-link" href="marcsjacobs-brand.html">Marc Jacobs</a></li>\
                                <li class="nav-item"><a class="nav-link" href="ralph-lauren.html">RALPH LAUREN</a></li>\
                                <li class="nav-item"><a class="nav-link" href="versace.html">VERSACE</a></li>\
                                <li class="nav-item"><a class="nav-link" href="yves-saint-laurent.html">YVES SAINT LAURENT</a></li>\
                            </ul>\
                        </li>\
                        <li class="nav-item submenu dropdown">\
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"\
