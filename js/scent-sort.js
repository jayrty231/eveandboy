...
var scent = $('.lattest-product-area').attr('id');
...
function buildScent() {
    for (var i = 0; i < products.length; i++) {
        if (products[i].productScent.includes(scent)) {
            buildSingle(i)
        }
    }
}
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">\
                    <ul class="nav navbar-nav menu_nav ml-auto">\
                        ...
                        <li class="nav-item active submenu dropdown">\
                            ...
                            <ul class="dropdown-menu">\
                                <li class="nav-item"><a class="nav-link" href="aqua-scent.html">Aqua</a></li>\
                                <li class="nav-item"><a class="nav-link" href="citrus-scent.html">Citrus</a></li>\
                                <li class="nav-item"><a class="nav-link" href="floral-scent.html">Floral</a></li>\
                                <li class="nav-item"><a class="nav-link" href="fruity-scent.html">Fruity</a></li>\
                                <li class="nav-item"><a class="nav-link" href="qourmand-scent.html">Gourmand</a></li>\
                                <li class="nav-item"><a class="nav-link" href="spice-scent.html">Spice</a></li>\
                                <li class="nav-item"><a class="nav-link" href="woody-scent.html">Woody</a></li>\
                            </ul>\
                        </li>\
                        <li class="nav-item submenu dropdown">\
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"\
